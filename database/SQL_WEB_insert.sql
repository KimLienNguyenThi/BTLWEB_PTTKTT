...
insert into DkiMuonSach (SDT, NgayDKMuon, NgayHen) values('0981724637','2023-12-19','2023-12-26');
use QuanLyThuVien
-- Them chi tiet dki
...
insert into ChiTietDK ( MaDK, MaSach, Soluongmuon) values ( 6, 3, 3);
insert into ChiTietDK ( MaDK, MaSach, Soluongmuon) values ( 6, 1, 2);
